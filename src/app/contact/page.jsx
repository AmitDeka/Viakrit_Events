...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact"
        description="Get in touch with Viakrit Events for corporate events, brand activations, government projects and on-ground marketing campaigns. Contact our team to plan, promote and execute your next event with professional support."
        keywords="contact event management company, event planner contact India, brand activation agency contact, corporate event services contact, event marketing agency India, hire event management company"
      />
        ...
        <section className="md:pt-48 md:pb-32 container flex flex-col justify-center px-6 pt-40 pb-20 mx-auto mb-16">
          <div className="md:flex-row md:items-end reveal-element flex flex-col items-start justify-between gap-8">
            ...
            <p className="text-on_surface_variant max-w-md">
              Looking for a reliable event management and brand activation
              partner? From concept to execution, we handle corporate events,
              promotional campaigns and large-scale programs that deliver real
              results. Reach out and let’s build something impactful.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 mb-32 md:mb-40 reveal-element relative min-h-[500px] md:h-[600px] surface-container border ghost-border rounded-xl flex items-center justify-center md:justify-start ambient-lift overflow-hidden group">
          ...
          <div className="relative z-10 w-[90%] md:w-full md:max-w-sm ml-0 md:ml-12 p-6 md:p-8 surface-container-highest border ghost-border ambient-lift box-shadow-xl inline-block bg-[#0e0e0f]/80 backdrop-blur-md">
            ...
            <p className="text-on_surface_variant md:mb-8 mb-6 text-sm font-medium leading-relaxed">
              Our high-stakes operations center is located in the heart of the
              Innovation District.
            </p>

            <div className="md:space-y-6 md:mb-8 mb-6 space-y-4">
              <div className="md:gap-4 flex items-start gap-3">
                <MapPin className="text-primary md:w-5 md:h-5 shrink-0 w-4 h-4 mt-1" />
                <div>
              ...
              <div className="md:gap-4 flex items-center gap-3">
                <div className="text-primary md:w-5 md:h-5 border-primary shrink-0 flex items-center justify-center w-4 h-4 border-2 rounded-full">
          ...
          <div className="hidden md:flex absolute md:right-[25%] right-10 top-1/2 -translate-y-1/2 z-10 flex-col items-center pointer-events-none">
            <div className="bg-primary/20 animate-pulse flex items-center justify-center w-12 h-12 rounded-full">
              <div className="bg-primary flex items-center justify-center w-8 h-8 text-black rounded-full">
