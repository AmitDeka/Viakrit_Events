...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title="Home"
        description="Viakrit Events is a full-service event management and brand activation company delivering corporate events, government projects, promotional campaigns and on-ground marketing across India. We plan, promote and execute experiences that drive visibility, engagement and real business impact."
        keywords="event management company India, promotional campaigns India, on ground marketing India, corporate event plannerevent management company India, brand activation agency, corporate event planner,event marketing agency, on ground marketing India, government event management, event planning services, promotional campaigns India"
      />
      <div ref={container} className="flex-1 w-full">
        ...
        <section className="container mx-auto px-6 pt-40 md:pt-48 pb-20 md:pb-32 min-h-[85vh] flex flex-col justify-center relative reveal-item">
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[7rem] font-display font-bold leading-none tracking-tight text-white mb-8 z-10 w-full max-w-4xl">
            Viakrit:
            <br /> Creative <br />
            <span className="text-primary-gradient">Experiences.</span>
          </h1>
          <p className="text-on_surface_variant md:text-lg relative z-10 max-w-xl mb-12 text-base font-medium leading-relaxed">
            We combine event planning, audience engagement, and strategic
            marketing to build premium recall for global brands.
          </p>
          <div className="sm:flex-row sm:w-auto z-10 flex flex-col w-full gap-4">
            <Button
              type="button"
              onClick={() => router.push("/contact")}
              className="sm:w-auto h-14 hover:scale-105 bg-primary w-full px-8 text-xs font-bold tracking-widest text-black transition-transform rounded-none">
              Start A Project →
            </Button>
            <Button
              variant="outline"
            ...
            <CarouselContent className="-ml-6">
                ...
                <div className="surface-container border ghost-border p-6 md:p-12 flex flex-col justify-end ambient-lift relative overflow-hidden min-h-[350px] md:min-h-[400px] h-full">
                  ...
                  <div className="md:pt-40 relative z-10 pt-32">
                    <p className="md:text-lg md:mb-8 md:pl-0 relative pl-4 mb-6 text-base italic font-medium leading-relaxed text-white">
                      "The Kinetic Curator team's technical acumen pushed this
                      to the absolute edge. Fast, uncompromised with relentless
              ...
              <CarouselItem className="md:basis-1/2 pl-6">
                <div className="surface-container border ghost-border p-6 md:p-12 flex flex-col justify-end ambient-lift relative overflow-hidden min-h-[350px] md:min-h-[400px] h-full">
                  ...
                  <div className="md:pt-40 relative z-10 pt-32">
                    <p className="md:text-lg md:mb-8 md:pl-0 relative pl-4 mb-6 text-base italic font-medium leading-relaxed text-white">
                      "We've never seen production quality like this. They
                      didn't just manage events; they defined policies and
                      curated that only elite tech could reach."
        ...
        <section className="container mx-auto px-6 mb-32 md:mb-40 reveal-item relative min-h-[500px] md:h-[600px] surface-container border ghost-border rounded-xl flex items-center justify-center md:justify-start ambient-lift overflow-hidden group">
          ...
          <div className="relative z-10 w-[90%] md:w-full md:max-w-sm ml-0 md:ml-12 p-6 md:p-8 surface-container-highest border ghost-border ambient-lift box-shadow-xl inline-block bg-[#0e0e0f]/80 backdrop-blur-md">
            ...
            <p className="text-on_surface_variant md:mb-8 mb-6 text-sm font-medium leading-relaxed">
              While we design experiences worldwide, our strategic hub is
